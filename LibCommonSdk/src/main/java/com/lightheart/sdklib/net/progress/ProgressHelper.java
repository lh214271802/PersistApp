package com.lightheart.sdklib.net.progress;
...
public class ProgressHelper {
    ...
    public void delRequestListener(String url, ProgressListener listener) {
        if (requestListenerMap == null || requestListenerMap.isEmpty()) return;
    ...
    public void delResponseListener(String url, ProgressListener listener) {
        if (responseListenerMap == null || responseListenerMap.isEmpty()) return;
